...
d3.json("https://cloud-cube.s3.amazonaws.com/ourp4ike3lex/public/us-10m.v1.json", function(error, us) {
  if (error) throw error;

  d3.tsv('https://gist.githubusercontent.com/Jasparr77/'
  +'80574e8c8409ca34a9fd29f33cfc6be5/raw/'
  +'a1e1e6de6d13c2082c8711f069fa2c25c1031df0/minWage.tsv', function(data){
...
.on("mouseover", function(d) {      
    div.transition()        
       ...
       div.html(
           d.name + "<br/>" 
           + d.Total.toLocaleString("en", {style: "percent",minimumFractionDigits:2})
        )
...
//                 .duration(700)
//                 .attr("fill", function(selection) {
//                     var datum = selection.Total;
//                     console.log(selection.Total)
//                     return ramp(datum);
//                 });
//    }
