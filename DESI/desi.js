...
var mainwidth = window.innerWidth - margin.left - margin.right,
  mainheight = window.innerHeight * 0.8 - margin.top - margin.bottom;
...
d3.tsv(
  "https://gist.githubusercontent.com/Jasparr77/673faca63682a4c8788025ac021a46df/raw/9525eccf53d6a5c1248c9ff0cf925eb29040d5c1/desi.tsv",
  function(data) {
    var line_data = d3
      .nest()
      .key(function(d) {
      ...
      .rollup(function(leaves) {
        return {
          totalScore: d3.sum(leaves, function(d) {
            return d["Weighted Score"];
          })
        };
      })
      .entries(data);
    ...
    var nested_data = d3
      .nest()
      .key(function(d) {
        return d.Year.concat(d.Country);
      })
      .sortKeys(d3.ascending)
      .rollup(function(leaves) {
        return {
    ...
    chartGroup
      ...
      .attr("d", function(d) {
        return yearline(d.values);
      })
      .attr("fill", "none")
      .attr("stroke-width", ".05vw")
      .attr("stroke", "lightgrey")
      .attr("transform", "translate(" + mainwidth * 0.1 + ",0)")
      .on("mouseover", function(d) {
        ...
        div
          ...
          .style(
            "top",
            d3.event.pageY -
              (margin.top + margin.bottom + mainheight / 10) +
              "px"
          );
      })
        ...
        div
          .html(
            d.country +
              ...
              "<br/>" +
              "Weighted DESI: " +
              d.totalScore.toLocaleString("en", {
                style: "decimal",
